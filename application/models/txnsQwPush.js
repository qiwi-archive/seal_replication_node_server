module.exports = model.methods({
    ...
    _init: function (params, done) {
        ...
        var payFlowParams = {
                ...
                add_zeros: code === 'QW_PUSH_DAYS' ? 1 : 0
            },
        ...
        parallel([
            function (done) {
                ...
                switch (code) {
                    case 'QW_PUSH_MINUTES':
                        fs.readFile(__dirname + '/sql/transactions/qw/push/five_minutes/oracle_select_qw_no_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PUSH_MINUTES_EXTRAS':
                        fs.readFile(__dirname + '/sql/transactions/qw/push/five_minutes/oracle_select_qw_with_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PUSH_DAYS':
                        fs.readFile(__dirname + '/sql/transactions/qw/push/day/oracle_select.sql', 'utf-8', done);
                        break;
                    case 'QW_PUSH_DAYS_EXTRAS':
                        fs.readFile(__dirname + '/sql/transactions/qw/push/day/oracle_select_with_extras.sql', 'utf-8', done);
                        break;
                }
            }, function (done) {
                switch (code) {
                    case 'QW_PUSH_MINUTES':
                        ...
                        break;
                    case 'QW_PUSH_MINUTES_EXTRAS':
                        fs.readFile(__dirname + '/sql/transactions/qw/push/insert_temp_table_with_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PUSH_DAYS':
                        fs.readFile(__dirname + '/sql/transactions/insert_temp_table.sql', 'utf-8', done);
                        break;
