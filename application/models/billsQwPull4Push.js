module.exports = model.methods({
    ...
    _init: function (params, done) {
        ...
        var code = '';
        if (params.isMinutes) {
            code = 'QW_PULL_FOR_PUSH_MINUTES';
        } else {
            code = 'QW_PULL_FOR_PUSH_DAYS';
        }
        ...
        var payFlowParams = {
                ...
                add_zeros: (code == 'QW_PULL_FOR_PUSH_DAYS' || code == 'QW_PULL_FOR_PUSH_MINUTES') ? 1 : 0
            },
        ...
        parallel([
            function (done) {
                ...
                switch (code) {
                    case 'QW_PULL_FOR_PUSH_MINUTES':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/five_minutes/oracle_select_qw_no_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PULL_FOR_PUSH_DAYS':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/day/oracle_select_no_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PULL_FOR_PUSH_MINUTES_EXTRAS':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/five_minutes/oracle_select_qw_with_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PULL_FOR_PUSH_DAYS_EXTRAS':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/day/oracle_select_with_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PULL_FOR_PUSH_DAYS_EXTRAS_15K':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/day/oracle_select_15k_with_extras.sql', 'utf-8', done);
                        break;
                    case 'QW_PULL_FOR_PUSH_DAYS_EXTRAS_15KPLUS':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/day/oracle_select_15kplus_with_extras.sql', 'utf-8', done);
                        break;
                }
            }, function (done) {
                switch (code) {
                    ...
                    case 'QW_PULL_FOR_PUSH_DAYS_EXTRAS_15KPLUS':
                    case 'QW_PULL_FOR_PUSH_DAYS_EXTRAS_15K':
                        fs.readFile(__dirname + '/sql/transactions/qw/pull4push/insert_temp_table_with_extras.sql', 'utf-8', done);
                        break;
                    default:
            ...
            var sqlMap = {
                ...
                providerDbQuoted: '\'QW\'',
                idProviderTransform: '\'QW_PULL_FOR_PUSH_\' || id_prv',
                paySourceTransform: 'CASE WHEN pflow_source IS NULL THEN NULL ELSE \'QW_\' || pflow_source END',
